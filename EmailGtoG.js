...
const sender = nodemailer.createTransport({
  ...
  secure: true,
  auth: {
    user: "1awaleshubham1@gmail.com",
    pass: "fphiilovxssspuwm",
  },
});

const options = {
  from: "1awaleshubham1@gmail.com",
  to: "awaleshubham0@gmail.com",
  subject: "Sending email of gmail through NM",
  text: "IMP",
  html: `
  <!doctype html>
<html>
...
.ExternalClass div {
                  ...
                  <table role="presentation" border="0" cellpadding="0" cellspacing="0" style="border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: 100%;" width="100%">
                    <tr>
                      <td style="font-family: sans-serif; font-size: 14px; vertical-align: top;" valign="top">
                        ...
                        <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; margin-bottom: 15px;">A bot is a software application that performs automated task and chatbots come under the category of bots that live in various chat platforms. A chatbot can converse with humans so the idea of conversation is primary to a chatbot..</p>
              ...
              <table role="presentation" border="0" cellpadding="0" cellspacing="0" style="border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: 100%;" width="100%">
                <tr>
                  <td class="content-block" style="font-family: sans-serif; vertical-align: top; padding-bottom: 10px; padding-top: 10px; color: #999999; font-size: 12px; text-align: center;" valign="top" align="center">
                    <span class="apple-link" style="color: #999999; font-size: 12px; text-align: center;">AwaleBrother's house, Hottal, Maharashtra.</span>
  ...
  attachments: [
    ...
    {
      filename: "laura-jones.jpg",
      path: __dirname + "/laura-jones.jpg",
    },
    {
      filename: "file.pdf",
